...
| [`test-suite-effectiveness-audit/`](test-suite-effectiveness-audit/README.md)    | Completed exhaustive test-value audit, remediation record, checked manifests, final evidence, and accepted residual boundaries.  |
...
different audit universes. References to completeness gates describe the
historical closeout process; the gates are no longer part of the live suite.
