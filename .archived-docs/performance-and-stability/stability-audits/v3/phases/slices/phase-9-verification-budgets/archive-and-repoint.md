...
- Move the closed v3 plan directory from `docs/plan/` to
  `.archived-docs/performance-and-stability/stability-audits/v3/`, unless the maintainer
...
- Repoint `fixCompletenessGateV3.test.ts` from `docs/plan/` to
  `.archived-docs/performance-and-stability/stability-audits/v3/`.
- Keep `fixCompletenessGate.test.ts` pointed at
  `.archived-docs/performance-and-stability/stability-audits/v1/`.
- Keep `fixCompletenessGateV2.test.ts` pointed at
  `.archived-docs/performance-and-stability/stability-audits/v2/`.
- Update `STRUCTURE.md`, `.archived-docs/README.md`, and any top-level plan
...
- The v3 plan exists under
  `.archived-docs/performance-and-stability/stability-audits/v3/` with closed status and
...
- `src/ts/__tests__/fixCompletenessGate.test.ts` and
  ...
  and v2 archives.
- `STRUCTURE.md` and `.archived-docs/README.md` route readers to the closed v3
  archive.
