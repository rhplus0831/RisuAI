...
[`../server-client-protocol-stability-performance`](../../../protocol-and-persistence/server-client-protocol),
and [`../lazy-projection`](../../../protocol-and-persistence/lazy-projection). Deferred follow-ups are in
