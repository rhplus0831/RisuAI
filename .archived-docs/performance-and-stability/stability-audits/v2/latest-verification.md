...
- Plan state: closed and archived on 2026-06-06. Phase 1 H1-H3,
  Phase 2's M5, M6, L3, L13, L14, L16,
...
- Gate state: the v1 gate
  ...
  (`src/ts/__tests__/fixCompletenessGateV2.test.ts`) is live against this
  archived v2 doc set and active-risk routing.
...
required commands passed; the archive/repoint slice then closed Phase 9.
