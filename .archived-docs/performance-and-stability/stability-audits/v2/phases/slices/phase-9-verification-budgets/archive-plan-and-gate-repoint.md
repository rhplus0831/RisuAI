...
- Move the closed v2 plan directory from `docs/plan/` to
  `.archived-docs/performance-and-stability/stability-audits/v2/`, unless the maintainer has
...
- The v2 plan exists under `.archived-docs/performance-and-stability/stability-audits/v2/`
