...
`.archived-docs/performance-and-stability/stability-audits/v4/`.
...
`.archived-docs/performance-and-stability/stability-audits/v3/` and was mid-execution while this
...
- The full v1/v2/v3 registries — 89 v3 findings (later closed in
  `.archived-docs/performance-and-stability/stability-audits/v3/active-risk-analysis.md`),
  the gated items (`v2-L12`, v1-L4/L7/L26/U2, the
  `.archived-docs/deferred-work/leftover.md` evidence gates), the no-action
