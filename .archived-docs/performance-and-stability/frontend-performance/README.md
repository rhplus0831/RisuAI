# Frontend Performance Deep-Clone Narrowing Plan (ARCHIVED 2026-06-04)

Date: 2026-06-04

> **ARCHIVED - moved out of active planning.** Moved from `docs/plan/` to
> `.archived-docs/performance-and-stability/frontend-performance/` on 2026-06-04. These docs are kept as the
> historical plan, verification record, and phase/slice detail; prefer
> [`../../STRUCTURE.md`](../../../STRUCTURE.md) and the code for current state.
...
- [`../../structure/server-resources-and-bridges.md`](../../../docs/structure/server-resources-and-bridges.md),
  [`../../structure/frontend.md`](../../../docs/structure/frontend.md), and
