...
follow-up slices (archived).
The alpha pass also closed memory event delivery isolation (archived).
...
Per-slice closeouts were archived during reorganization; this file
keeps only the closed-phase summary and boundaries.
