...
> `.archived-docs/durable-generation/` on 2026-05-30. Milestone 1 (survive client
...
needs both. Reverse-direction marker: `.archived-docs/client-thinning/plan.md` "Out Of Scope Here".
...
Once stable, shard like `.archived-docs/client-thinning/` (router + shards). One doc while drafting.
