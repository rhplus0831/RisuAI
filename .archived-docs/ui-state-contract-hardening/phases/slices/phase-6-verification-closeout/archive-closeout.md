...
- `.archived-docs/ui-state-contract-hardening/`
- `.archived-docs/README.md`
- `STRUCTURE.md`
- `.archived-docs/ui-state-contract-hardening/latest-verification.md`
- `.archived-docs/ui-state-contract-hardening/status.md`

## Target Shape

- Workstream files move under `.archived-docs/ui-state-contract-hardening/`.
...
```bash
pnpm exec prettier --check STRUCTURE.md .archived-docs/README.md '.archived-docs/ui-state-contract-hardening/**/*.md'
git diff --check
```
