...
| [Performance and stability](performance-and-stability/README.md)             | Frontend test/runtime and clone narrowing, chat multitasking regressions, and the four chronological stability/performance audits.                 |
