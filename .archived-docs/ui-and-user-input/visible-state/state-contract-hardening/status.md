...
- Phase 6 archive closeout is complete: the workstream moved from `docs/plan/`
  to `.archived-docs/`, archive navigation and `STRUCTURE.md` were updated, and
...
- Archived under `.archived-docs/ui-and-user-input/visible-state/state-contract-hardening/` on 2026-06-11.
