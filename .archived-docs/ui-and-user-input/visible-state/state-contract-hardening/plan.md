...
- Current structure docs are authoritative for active behavior:
  [`../../structure/testing-and-operations.md`](../../../../docs/structure/testing-and-operations.md),
  [`../../structure/frontend.md`](../../../../docs/structure/frontend.md),
...
- The archived v2 plan supplies the structure pattern for phases, source
  ...
  [`../audit-stability-and-performance-v2/`](../../../performance-and-stability/stability-audits/v2/).
- The archived chat-scoped generation-settings plan supplies context only; it
  remains closed and is not extended here:
  [`../chat-scoped-generation-settings/`](../../../generation-and-models/chat-scoped-generation-settings/).
...
- No archive edits except navigation notes that would otherwise become false.
  ...
  `.archived-docs/` and updating active/archive navigation is part of closeout
