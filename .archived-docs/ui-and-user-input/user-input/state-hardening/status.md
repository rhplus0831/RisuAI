...
persistence inventory, verification, and stale-state risk review under
...
- [Phase 6](phases/phase-6-resync-memory-navigation.md): complete. Memory
  ...
  import refresh/navigation now returns stable imported `chaId`s, re-resolves
...
- Treat `Issue` rows in [`../audit-records/`](../audit-records/) as source-row drift
