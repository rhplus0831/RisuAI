...
> `docs/lazy-projection/` to `.archived-docs/protocol-and-persistence/lazy-projection/` after a source/history
...
workstream — the successor to [`client-thinning`](../../architecture-and-migration/client-thinning-closeout/README.md) and
[`durable-generation`](../../generation-and-models/durable-generation/README.md). Those two closed
