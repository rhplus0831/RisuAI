...
- [`../../AUDIT.md`](audits/fastify-side-effect-audit.md) seeded the risk inventory and priority order for
  this plan; [`status.md`](status.md) records which items have since closed.
- [`../../SERVER-AND-CLIENT.md`](audits/server-client-ownership.md) owns the server/client
  responsibility split.
- [`../../SERVER-AND-CLIENT-PROTOCOL.md`](audits/server-client-protocol.md) owns
