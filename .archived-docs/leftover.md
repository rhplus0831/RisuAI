...
- Evidence: `server/fastify/src/prompt/luaRuntime.ts`;
  `.archived-docs/client-thinning/phases/slices/slice-3b-lua/README.md`.
...
- Evidence: `server/fastify/src/routes/commands.ts` (the four routes);
  `.archived-docs/mutation-range-mismatch/phases/phase-6-message-free-ceiling.md`;
  `.archived-docs/mutation-range-mismatch/active-risk-analysis.md` (Tier 5).
