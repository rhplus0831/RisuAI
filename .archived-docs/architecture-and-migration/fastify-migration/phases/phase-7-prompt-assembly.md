...
closed in follow-up slices 7A-7E (archived).
...
- Live handoff: [`../README.md`](../README.md)
- Server status: [`../README.md`](../README.md)
- sendChat status: [`../README.md`](../README.md)
- Provider matrix: [`../other/coverage-records/providers.md`](../other/coverage-records/providers.md)
