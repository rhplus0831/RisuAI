...
| Verification/docs | **Ongoing.** | Latest verification batch is recorded in [`../latest-verification.md`](../latest-verification.md), and status/coverage shards match current source. |
