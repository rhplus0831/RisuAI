...
> `.archived-docs/architecture-and-migration/client-thinning-closeout/` on 2026-05-30. The A-item blockers (A1/A2/A3) are
...
> deferrals live in [`../../leftover.md`](../../deferred-work/leftover.md); the current architecture
...
8. [`coverage.md`](status/README.md#verification-coverage) — test/audit coverage router.
...
- Latest recorded verification: [`latest-verification.md`](latest-verification.md).
