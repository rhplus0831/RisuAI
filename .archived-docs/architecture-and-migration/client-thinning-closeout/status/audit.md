...
or selecting audit work. This is the canonical audit shard; its proof is
consolidated under [Verification Coverage](#verification-coverage).
...
Canonical audit shard is [`../status/audit.md`](audit.md) — read it for
