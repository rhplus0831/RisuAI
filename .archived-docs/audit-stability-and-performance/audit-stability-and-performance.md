...
- Prior workstreams are in `.archived-docs/frontend-performance`,
  `.archived-docs/server-client-protocol-stability-performance`, and
  `.archived-docs/lazy-projection`. This audit reports current-code gaps, not
  already-fixed issues.
- `.archived-docs/leftover.md` tracks deferred or evidence-gated follow-ups.
...
- Findings tagged [known-leftover] are already tracked in
  `.archived-docs/leftover.md`. They remain listed for completeness; H1, H2, H3
