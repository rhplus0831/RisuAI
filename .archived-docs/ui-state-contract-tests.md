...
- `.archived-docs/audit-stability-and-performance-v3/plan.md`
- `.archived-docs/audit-stability-and-performance-v3/phases/phase-5-client-write-path-correctness.md`
- `.archived-docs/audit-stability-and-performance-v3/phases/phase-6-reactive-amplification-and-render.md`
- Recent commits:
