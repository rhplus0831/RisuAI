...
`.archived-docs/generation-and-models/model-config-profiles/` workstream, which added durable profile
...
records the final proof level and Phase 6 closeout. [`decisions.md`](decisions.md)
...
- `.archived-docs/generation-and-models/model-config-profiles/` captures the completed durable
