...
This completed workstream expands [`product-qa.md`](product-qa.md)
...
`.archived-docs/generation-and-models/model-profile-authoring-ui/`; their contents are Agent
Preset-specific.
...
- [`product-qa.md`](product-qa.md) captures the original
  product Q&A and agreed alignment answers.
- `.archived-docs/generation-and-models/model-profile-authoring-ui/` provides the folder and file
  skeleton only.
