...
> `.archived-docs/generation-and-models/durable-generation/` on 2026-05-30. Milestone 1 (survive client
...
> server _restart_) is deferred. Open items: [`../../leftover.md`](../../deferred-work/leftover.md).
...
> [`../lazy-projection/`](../../protocol-and-persistence/lazy-projection/README.md). The M1 notes below are
...
Remaining open/ambiguous tasks live in [`../../leftover.md`](../../deferred-work/leftover.md).
...
needs both. Reverse-direction marker: `.archived-docs/architecture-and-migration/client-thinning-closeout/plan.md` "Out Of Scope Here".
...
Once stable, shard like `.archived-docs/architecture-and-migration/client-thinning-closeout/` (router + shards). One doc while drafting.
