# DL2 data-loss delta audit — Pass 4 brief: Import boundaries
...
2. Your surface is the charter section **"Pass 4 — Import boundaries"**. Work
...
## Free-hunt findings
Same finding format, IDs DL2-P4-F<k>.
