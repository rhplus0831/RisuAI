# DL2 data-loss delta audit — Pass 2 brief: Script-originated durable writes
...
2. Your surface is the charter section **"Pass 2 — Script-originated durable writes"**. Work
...
## Free-hunt findings
Same finding format, IDs DL2-P2-F<k>.
