...
- `.archived-docs/audit-stability-and-performance-v2/audit-stability-and-performance-v2.md`
  H3, M17, and L40.
- `.archived-docs/audit-stability-and-performance-v2/latest-verification.md`
  (record the observed baseline counts).
