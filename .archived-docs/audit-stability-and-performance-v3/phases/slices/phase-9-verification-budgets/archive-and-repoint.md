...
- Move the closed v3 plan directory from `docs/plan/` to
  `.archived-docs/audit-stability-and-performance-v3/`, unless the maintainer
...
- Repoint `fixCompletenessGateV3.test.ts` from `docs/plan/` to
  `.archived-docs/audit-stability-and-performance-v3/`.
- Keep `fixCompletenessGate.test.ts` pointed at
  `.archived-docs/audit-stability-and-performance/`.
- Keep `fixCompletenessGateV2.test.ts` pointed at
  `.archived-docs/audit-stability-and-performance-v2/`.
...
- The v3 plan exists under
  `.archived-docs/audit-stability-and-performance-v3/` with closed status and
