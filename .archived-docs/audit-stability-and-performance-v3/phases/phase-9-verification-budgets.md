...
[`../../audit-stability-and-performance-v2/phases/phase-9-verification-budgets.md`](../../audit-stability-and-performance-v2/phases/phase-9-verification-budgets.md)).
...
- [archive-and-repoint](slices/phase-9-verification-budgets/archive-and-repoint.md) -
  moved the closed v3 plan to `.archived-docs/audit-stability-and-performance-v3/`,
