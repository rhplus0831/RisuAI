...
- Gate state: the v1 gate (`src/ts/__tests__/fixCompletenessGate.test.ts`)
  ...
  `.archived-docs/audit-stability-and-performance-v3/`, with every scheduled
...
([`../audit-stability-and-performance-v2/latest-verification.md`](../audit-stability-and-performance-v2/latest-verification.md))
