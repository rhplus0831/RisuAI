...
| [7: Hardening and rollout](07-hardening-and-rollout.md) | Outstanding | External observer rollout evidence and owners; supported-client aggregate-route usage; the observer flag decision; and the final evidence package. |
...
- [x] 4B. Shell-independent optional work.
- [x] 4C. Plugin readiness.
- [x] 4D. Chat-specific readiness.

### Phase 5: Route-driven hydration

- [x] 5A. Consumer inventory and manifest contract.
- [x] 5B. Minimal coherent shell resource.
- [x] 5C. Route-scoped loader.
- [x] 5D. Invalidation, prefetch, and failure isolation.
...
- [x] 6D. Permanent observer and retry behavior.

### Phase 7: Hardening and rollout

- [x] 7A. Integration matrix.
- [x] 7B. Telemetry and privacy.
- [x] 7C. Documentation and developer workflow.
