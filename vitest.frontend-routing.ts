...
// still making new plain tests Node-default. Remove an entry when its owner is
// renamed to an explicit DOM suffix.
export const legacyDomTestFiles = [
  ...
  'src/lib/Others/resourceGuard.test.ts',
  ...
  'src/ts/process/__tests__/notification.test.ts',
  ...
  'src/ts/process/memory/contextualEmbedding.test.ts',
  'src/ts/process/memory/remoteEmbeddingPaths.test.ts',
  ...
  'src/ts/server/serviceWorker.test.ts',
  ...
  'src/ts/storage/fastifyStorage.test.ts',
  'src/ts/translator/pipeline.test.ts',
