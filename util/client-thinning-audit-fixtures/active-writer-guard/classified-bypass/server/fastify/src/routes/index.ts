...
export function registerRoutes(app: RouteApp): void {
  ...
  app.post('/api/v1/settings', noop)
  app.post('/api/v1/settings/:group', noop)
  app.post('/api/v1/collections', noop)
  app.post('/api/v1/collections/:name', noop)
  app.post('/api/v1/characters', noop)
  app.post('/api/v1/characters/:id/lorebook', noop)
  app.post('/api/v1/legacy-presets/:id', noop)
  app.post('/api/v1/prompt-presets/:id/template', noop)
