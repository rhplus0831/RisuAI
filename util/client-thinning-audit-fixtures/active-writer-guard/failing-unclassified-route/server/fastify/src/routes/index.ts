...
export function registerRoutes(app: RouteApp): void {
  // Anti-pattern: a new server-owned mutation route with no classification in
  // the audit's MUTATING_ROUTE_RULES table (neither guarded nor exempt).
  app.post('/api/v1/widgets', noop)
