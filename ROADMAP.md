...
- **7-7a** — constant (always-on) entries; ports the decorator
  parser scaffolding that the rest of the chain depends on.
- **7-7b** — keyword matching activation (after 7-7a).
