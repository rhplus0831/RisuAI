...
| Document | Owns |
| --- | --- |
| [`backend.md`](backend.md) | Fastify composition, security hooks, route families, commands, generation jobs, and workers |
...
| [`server-resources-and-bridges.md`](server-resources-and-bridges.md) | Browser resource state, hydration, durable mutation replay, invalidation, and settings/data bridges |
| [`assets-and-saves.md`](assets-and-saves.md) | Content-addressed assets, `.risu` formats, imports/exports, Realm conversion, and backup/restore |
...
| [`generated-and-legacy.md`](generated-and-legacy.md) | Generated, vendored, ignored, compatibility-only, and deliberately absent surfaces |
