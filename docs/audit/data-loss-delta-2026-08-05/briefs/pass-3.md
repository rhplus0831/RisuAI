# DL2 data-loss delta audit — Pass 3 brief: Destructive and confirm-gated flows
...
2. Your surface is the charter section **"Pass 3 — Destructive and confirm-gated flows"**. Work
...
## Free-hunt findings
Same finding format, IDs DL2-P3-F<k>.
