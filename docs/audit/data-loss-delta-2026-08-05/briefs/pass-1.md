# DL2 data-loss delta audit — Pass 1 brief: Round-trip completeness for post-closure stores
...
2. Your surface is the charter section **"Pass 1 — Round-trip completeness for post-closure stores"**. Work
...
## Free-hunt findings
Same finding format, IDs DL2-P1-F<k>.
