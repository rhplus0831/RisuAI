...
| NovelAI text                            | NovelAI text-generation API               | local only | waits for Phase 7 closeout / server-owned flattening follow-up; see `../design/novelai-novellist-stringlize.md` |
| NovelList                               | NovelList API                             | local only | waits for Phase 7 closeout / server-owned flattening follow-up; see `../design/novelai-novellist-stringlize.md` |
| ooba OAI-compatible                     | `/v1/completions` with Jinja chat template flattening | local only | waits for Phase 7 closeout / server-owned flattening follow-up; see `../design/ooba-oai-compat.md` |
