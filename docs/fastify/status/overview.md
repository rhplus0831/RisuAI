...
| 7 - Server-side prompt assembly         | in progress | Slices 7-1 through 7-6d plus 7-5c landed; next slice is 7-7a lorebook constants. |
...
- **Server.** Captured in [`server.md`](server.md). Phases 1-3 are
  ...
  prompt leaves through history shaping, regex scripts, and module
  helpers. Docker targets
