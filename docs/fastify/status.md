...
- Last landed slice: 8-5d, pure similarity ranking.
- Current blocker: none recorded.
- Next default pickup: 8-5e, pure memory budget allocator.
...
| Hypa V3 memory                              | Active; next slice is 8-5e pure memory budget allocator.                     |
