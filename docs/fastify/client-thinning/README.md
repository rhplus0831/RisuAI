...
Progress as of 2026-05-28: **EC1, EC2, and EC3 are closed**. The next pickup is
**EC4 — Stable-id validation + prompt-item semantics**; see
[`closeout-buckets.md`](./closeout-buckets.md).
...
- [`final-audit.md`](./final-audit.md) — the consolidated EC1–EC7 validation pass
  whose corrections are folded into this doc set.
