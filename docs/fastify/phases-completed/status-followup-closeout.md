...
| --------------------------------------- | ------------ | --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| 0 - Removals                            | Closed       | 0A removed the tracked Google Drive OAuth worker from `public/` and verified the build.                   | [`phase-0-removals-followup.md`](phase-0-removals-followup.md)               |
...
| 3 - Proxy migration                     | Closed       | 3A shared direct proxy response-header filtering with stream-job `upstream_headers` events.               | [`phase-3-proxy-followup.md`](phase-3-proxy-followup.md)                     |
...
| 6 - Server-side generation              | Closed       | 6C aligned Ollama NDJSON stream failures with typed error frames and completed the final stream audit.    | [`phase-6-generation-followup.md`](phase-6-generation-followup.md)           |
| 7 - Server-side prompt assembly         | Closed       | 7E added route-backed fixture coverage for send, continue, regenerate, preview, and preview-prompt paths. | [`phase-7-prompt-assembly-followup.md`](phase-7-prompt-assembly-followup.md) |
| 8 - Hypa V3 memory                      | Closed       | 8C added missing-summary diagnostics and follow-ups for chunks with no embedding yet.                     | [`phase-8-memory-followup.md`](phase-8-memory-followup.md)                   |
| 9 - Client thinning                     | Closed       | 9J removed the remaining focused direct-bind hits, covered allowlist gaps, and passed browser smoke.      | [`phase-9-client-thinning-followup.md`](phase-9-client-thinning-followup.md) |
