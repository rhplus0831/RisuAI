...
AEC1, AEC2, and AEC3 are closed; AEC4 through AEC7 remain open. The original
read-only cross-verification found two High, three Medium, and five Low findings; see
...
reserved-key blind spot. That pass is still not an alpha closeout signal because
AF5 through AF10 remain open.
