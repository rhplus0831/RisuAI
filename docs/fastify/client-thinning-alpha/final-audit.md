...
AEC1 and AEC3 are closed; AEC2 is partially closed because AF2 is resolved and
AF4 remains open; AEC4 through AEC7 remain open. The original read-only
...
AF3's preset-image walker/validator blind spot. That pass is still not an alpha
closeout signal because AF4 through AF10 remain open.
