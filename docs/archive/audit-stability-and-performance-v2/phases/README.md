...
This archived phase index records the closed v2 remediation workstream. Use
these files for historical phase scope, exit criteria, and slice routing.
Concrete slices live under `slices/[phase]/[slice-name].md`. Every finding ID is defined
in
...
- Phase 9, complete (verification budgets; the v2 gate, closing run, archive):
  [`phase-9-verification-budgets.md`](phase-9-verification-budgets.md).

Phases 4-8 were independent of each other and landed via separate branches.
Phases 0-9 have landed; no active next phase remains in this archive.
