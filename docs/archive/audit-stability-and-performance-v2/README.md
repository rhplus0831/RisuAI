...
> `docs/archive/audit-stability-and-performance-v2/` on 2026-06-06 after
...
> archive at `docs/archive/audit-stability-and-performance-v2/`; the v1 gate
> remains live against `docs/archive/audit-stability-and-performance/`.
