...
This archived phase index records the closed v3 remediation workstream. Use
these files for historical phase scope, exit criteria, and slice routing.
Concrete slices live under `slices/[phase]/[slice-name].md`. Every finding ID
is defined in
...
- Phase 8, complete (Theme 8: client interpreters, plugins, media; M7,
...
- Phase 9, complete (verification budgets; the v3 gate, closing run, archive):
