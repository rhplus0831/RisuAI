...
> `docs/archive/audit-stability-and-performance/` on 2026-06-05 after all
...
[`../structure/`](../../structure/). Closed perf workstreams are in
[`../archive/frontend-performance`](../../archive/frontend-performance),
[`../archive/server-client-protocol-stability-performance`](../../archive/server-client-protocol-stability-performance),
and [`../archive/lazy-projection`](../../archive/lazy-projection). Deferred
follow-ups are in [`../archive/leftover.md`](../../archive/leftover.md).
