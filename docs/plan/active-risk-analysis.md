...
highs and Phase 2 server-root work are done; continue with Phase 3 unless
current evidence points elsewhere. Every fix needs a regression test and Phase 8
gate entry.
