...
One slice migrates one resource family or removes one now-unused infrastructure
...
Active slice:
[Lorebook page consumer migration](phase-2-leaf-settings-and-collections/lorebook-page-consumer-migration.md).
