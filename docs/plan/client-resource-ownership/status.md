...
- 9,899 exact compatibility references grouped into 326 consumer records and 56
  resource-family/role policies.
- Lanes: 3,322 production, 6 server, and 6,571 test references.
- Families: broad settings/shell 1,046; character/chat 1,773; compatibility
  infrastructure 2,062; cross-cutting 1,428; leaf settings/collections 1,854;
