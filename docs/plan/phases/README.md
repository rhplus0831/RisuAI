...
| 2     | Hot commands targeted; measurement implemented | [`phase-2-command-write-cost.md`](phase-2-command-write-cost.md)                     | [`slices/phase-2-command-write-cost/`](slices/phase-2-command-write-cost/)                     |
| 3     | Read optimizations + measurements implemented  | [`phase-3-read-projection-efficiency.md`](phase-3-read-projection-efficiency.md)     | [`slices/phase-3-read-projection-efficiency/`](slices/phase-3-read-projection-efficiency/)     |
...
| 5     | Implemented + export measurement implemented   | [`phase-5-import-export-asset-memory.md`](phase-5-import-export-asset-memory.md)     | [`slices/phase-5-import-export-asset-memory/`](slices/phase-5-import-export-asset-memory/)     |
