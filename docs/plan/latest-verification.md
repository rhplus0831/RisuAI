...
- Plan state: open; Phase 0, Phase 1, Phase 2, Phase 3, and Phase 4 are
  ...
  `L11-L30`, `L34-L37`, `L56`, `K1`, and `K2` are `DONE` in
...
- Gate state: the v1 gate (`src/ts/__tests__/fixCompletenessGate.test.ts`)
  ...
  `L11-L30`, `L34-L37`, `L56`, `K1`, and `K2` registered as
...
- Tree: Phase 5 implementation is committed through `68edd23d7`; this
  ...
  the L22 `draft-mirror-gating`, L28/L29 `watcher-short-circuits`, and L30
  `parse-memo-key-caching` runtime, tests, and docs proof. The earlier
