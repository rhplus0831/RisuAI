...
audit, event atomicity, expanded import limits, and bundle export streaming.
...
`.risu` export materialization, broader asset durability and per-generation
asset caching, client watcher echo, route operation guards, and verification
budgets.
...
3. Address remaining asset durability and per-generation asset caching in
   Phase 5.
