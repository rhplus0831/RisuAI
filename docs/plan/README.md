...
| --- | --- | --- | --- |
| [Cross-runtime boundaries](cross-runtime-boundaries/PLAN.md) | Active | [Phase 3 model-role resolution](cross-runtime-boundaries/status.md) | Twelve neutral leaves are released through `1b1152814`; 314 direct root-`src` edges remain. |
