...
| --- | --- | --- | --- |
| [Cross-runtime boundaries](cross-runtime-boundaries/PLAN.md) | Active | [Phase 4 prompt-info snapshot](cross-runtime-boundaries/status.md) | Twenty-nine neutral leaves, Fastify-local prompt state, and protocol contracts reduce the checked boundary to 165 direct root-`src` edges. |
