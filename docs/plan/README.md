...
| --- | --- | --- | --- |
| [Cross-runtime boundaries](cross-runtime-boundaries/PLAN.md) | Active | [Phase 2 browser operation metadata reconciliation](cross-runtime-boundaries/status.md) | The 103 route operations and 129 durable command operations are shared at `3f275e9dc`; 336 direct root-`src` edges remain. |
