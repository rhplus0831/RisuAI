...
| --- | --- | --- | --- |
| [Cross-runtime boundaries](cross-runtime-boundaries/PLAN.md) | Active | [Phase 3 agent-only lorebook predicate](cross-runtime-boundaries/status.md) | Thirteen neutral leaves are released through `22d6799dd`; 303 direct root-`src` edges remain. |
