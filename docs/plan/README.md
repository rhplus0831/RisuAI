...
| --- | --- | --- | --- |
| [Cross-runtime boundaries](cross-runtime-boundaries/PLAN.md) | Active | [Phase 4 dependency/closure selection](cross-runtime-boundaries/status.md) | Twenty-five neutral leaves, Fastify-local prompt state, and protocol contracts reduce the checked boundary to 181 direct root-`src` edges. |
