...
| --- | --- | --- | --- |
| [Cross-runtime boundaries](cross-runtime-boundaries/PLAN.md) | Active | [Phase 4 parser character type seam](cross-runtime-boundaries/status.md) | Thirty neutral leaves, Fastify-local prompt state, and protocol contracts reduce the checked boundary to 164 direct root-`src` edges. |
