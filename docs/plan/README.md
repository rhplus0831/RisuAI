...
| --- | --- | --- | --- |
| [Cross-runtime boundaries](cross-runtime-boundaries/PLAN.md) | Active | [Phase 1 protocol contract completion](cross-runtime-boundaries/status.md) | Shell, character-summary, provider, embedding, and image-generation contracts are released; 357 direct root-`src` edges remain. |
