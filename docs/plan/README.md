...
This directory turns the v3 stability/performance audit into a phased repair
...
(K1-K4). The plan groups them by cross-cutting theme and requires a
...
and [`../structure/`](../structure/). Closed workstreams are indexed in
[`../archive/README.md`](../archive/README.md); deferred follow-ups are in
[`../archive/leftover.md`](../archive/leftover.md).
