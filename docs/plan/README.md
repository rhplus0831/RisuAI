...
| --- | --- | --- | --- |
| [Cross-runtime boundaries](cross-runtime-boundaries/PLAN.md) | Active | [Phase 3 punctuation trimming](cross-runtime-boundaries/status.md) | Seven neutral leaves are released through `12d2840b1`; 322 direct root-`src` edges remain. |
