...
- `docs/archive/audit-stability-and-performance-v3/plan.md`
- `docs/archive/audit-stability-and-performance-v3/phases/phase-5-client-write-path-correctness.md`
- `docs/archive/audit-stability-and-performance-v3/phases/phase-6-reactive-amplification-and-render.md`
- Recent commits:
