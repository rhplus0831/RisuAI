...
- Plan state: open. Phases 1-3 and Phase 8 are implemented and
  proof-refreshed; Phase 4 is the next fix batch in this branch's remaining
  route.
...
- Scheduled IDs: H1-H3, Phase 2's M5, M6, L3, L13, L14, L16, K1, and K2,
  Phase 3's M1-M4 and L4-L11, and Phase 8's L1, L2, L15, and L17-L31 are
...
- Current Phase 8 proof: focused server-bound suites passed (17 files / 297
  tests), the v2 gate passed (18 tests), `pnpm api:test` passed (1846 passed /
  1 skipped), and both TypeScript checks passed. See
