...
- Plan state: open. Phases 1-3 and Phase 7 are implemented and
  proof-refreshed; Phase 4 remains the next fix batch.
...
- Scheduled IDs: H1-H3, Phase 2's M5, M6, L3, L13, L14, L16, K1, and K2,
  ...
  K3 are registered `DONE` in the v2 gate and `active-risk-analysis.md`.
  Remaining scheduled gate entries stay `PLANNED`; remaining risk-map rows
  stay `PENDING`.
...
- Current Phase 7 proof: focused translate/UI/TTS/MCP/file-import suites,
