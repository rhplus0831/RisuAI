...
- Plan state: open. Phases 1-4 are implemented and proof-refreshed; Phase 5
...
- Scheduled IDs: H1-H3, Phase 2's M5, M6, L3, L13, L14, L16, K1, and K2,
  Phase 3's M1-M4 and L4-L11, and Phase 4's M7-M10, L32-L34, L37, and K4 are
...
- Current Phase 4 proof: focused client clone/rollback suites, supplemental
