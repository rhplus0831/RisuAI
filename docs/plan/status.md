...
- Plan state: open. Phases 1-3 and Phase 6 are implemented and
  proof-refreshed; Phase 7 is the next fix batch after Phase 6.
...
- Scheduled IDs: H1-H3, Phase 2's M5, M6, L3, L13, L14, L16, K1, and K2,
  Phase 3's M1-M4 and L4-L11, and Phase 6's M11, M12, M14, L35, L36,
...
- Current Phase 6 proof: focused bridge, DOM observer, character-row,
  reroll-lifecycle, reconnect, MCP SSE, and `fetchNative` suites, both gates,
...
- [Phase 7](phases/phase-7-opt-in-subsystems.md): next. Translate/TTS/
