...
- Prior workstreams are in `docs/archive/frontend-performance`,
  `docs/archive/server-client-protocol-stability-performance`, and
  `docs/archive/lazy-projection`. This audit reports current-code gaps, not
  already-fixed issues.
- `docs/archive/leftover.md` tracks deferred or evidence-gated follow-ups.
...
- Findings tagged [known-leftover] are already tracked in
  `docs/archive/leftover.md`. They remain listed for completeness; H1, H2, H3
