...
The newest code change is `75082c48` (`refactor: harden 4 client-thinning audit
...
with adversarial fixtures; the audit fixture suite is now 52 tests.
...
- Audit reproducibility is complete (21 rules, 52 tests). The four empirically
  defeated rules are hardened; remaining shallow rules are optional follow-up
