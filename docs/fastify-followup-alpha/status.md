...
- Active work: none. The alpha audit, broad closeout, and `LEFTOVER.md`
  audit pickup are closed.
- Latest closeout: the local `LEFTOVER.md` pickup closed Phase 3 request
  control-header filtering, Phase 9 command-owned projection-write
  leftovers, and the Phase 7 coverage note. Full verification passed on
  2026-05-27.
- No follow-up remains open for Phases 0, 1, 2, 4, or 7.
...
| 9 - Client thinning                     | Closed       | Command-owned chat/message, chat-list, character-restore, persona-pin, translator-preset, character-import, prompt-diff, and NanoGPT projection-write leftovers are closed for this pass. | [`phases-completed/leftover-audit-closeout.md`](phases-completed/leftover-audit-closeout.md)                 |
