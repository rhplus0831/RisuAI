...
| R-05 | Model profile drawer | Fixed | complete | complete | complete | fix: guard stale model profile edit saves | Edit saves now guard missing profile targets and show a stale-target error instead of creating. |
