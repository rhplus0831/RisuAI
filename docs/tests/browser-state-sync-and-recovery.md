...
- Agent/persona/translator: standalone Agent create/update/delete/duplicate/reorder; Agent Preset
  ...
  delete/select.
- Characters/chats/messages: character create/create-and-select/delete/select/alternate-greeting update; chat create/reorder,
