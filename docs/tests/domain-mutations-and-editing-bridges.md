...
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Settings and prompts      | `src/ts/server/promptTemplateMutations.svelte.test.ts`; `settingsBridge.durable.test.ts`; `settingsBridge.svelte.test.ts`; `src/ts/storage/database.svelte.test.ts`                                                                                                                                                                                                       |
