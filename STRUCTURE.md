...
| `server/fastify/src/db.ts`, `server/fastify/src/databaseLineage.ts`                                                                         | SQLite schema v25, migrations, global revision, database lineage, durable writer epoch, and command-mutation receipts.      |
