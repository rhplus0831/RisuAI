...
| `docs/archive/audit-stability-and-performance-v3/`                                                      | Closed v3 stability/performance remediation workstream; no active `docs/plan/` workstream exists.                |
| `docs/archive/audit-stability-and-performance-v4/`                                                      | Archived v4 stability/performance audit and detailed finding registry; remediation was routed through v3 closeout. |
