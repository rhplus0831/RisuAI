...
| `docs/agent-preset-plan.md`, `docs/prompt-template-ownership-cleanup/`, `docs/deferred-features*.md`, `docs/ui-flow-stale-state-audit*.md` when present | Open and retained implementation plans, phase routers, and audit progress notes.                     |
