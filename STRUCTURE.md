...
| `.archived-docs/`                                                                                       | Closed workstreams and dated reports grouped under six topic folders. Prefer code and current structure docs for behavior; the v1-v3 stability/performance audit and risk Markdown files remain fixtures for explicit completeness gates. |
