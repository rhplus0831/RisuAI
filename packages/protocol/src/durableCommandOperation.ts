...
export const PROTOCOL_DURABLE_COMMAND_OPERATION_CATALOG = [
  ...
  { id: 'module-folder-create', method: 'POST', path: /^\/module-folders$/, examplePath: '/module-folders' },
  {
    id: 'module-folder-patch',
    method: 'PATCH',
    path: /^\/module-folders\/[^/?#]+$/,
    examplePath: '/module-folders/folder-a',
  },
  {
    id: 'module-folder-delete',
    method: 'DELETE',
    path: /^\/module-folders\/[^/?#]+$/,
    examplePath: '/module-folders/folder-a',
  },
  {
    id: 'module-folder-reorder',
    method: 'POST',
    path: /^\/module-folders\/reorder$/,
    examplePath: '/module-folders/reorder',
  },
