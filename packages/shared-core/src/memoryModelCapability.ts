...
export type MemoryProviderCapability = { routable: true; provider: string } | { routable: false; reason: string }

export function resolveMemoryModelCapability(profile: {
  providerCapability: MemoryProviderCapability
