import { resolveEffectivePromptTemplate } from './effectivePromptTemplate.js'
import type {
  CbsCallbackMemo,
  CbsCallbackMemoName,
  CbsCharacter as character,
  CbsDatabase as Database,
  CbsLoreBook as loreBook,
  CbsMatcherArg as matcherArg,
  CbsModule as RisuModule,
  CBSModelContext,
  CBSModelRole,
  CBSRegisterArg,
  RegisterCallback,
