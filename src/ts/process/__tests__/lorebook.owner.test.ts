...
// Regression coverage: global lorebook add, folder, and import helpers must
// mutate the current collection owner and dispatch the matching durable command.
...
describe('global lorebook durable owner writes', () => {
