export const languageEnglish = {
  ...
  pushNotifications: {
    ...
    compensating: 'Turning the notification setting back off…',
    retryingCompensation: 'Retrying the notification setting update…',
    retryingStorage: 'Retrying device notification storage…',
    retryingCleanup: 'Retrying notification cleanup…',
    compensationAccepted: 'The notification setting was restored to off.',
    compensationQueued: 'Turning notifications off is queued and will retry automatically.',
    compensationFailed: 'The notification setting could not be turned off. Retry this update.',
    retryCompensation: 'Retry turning off',
    ...
    setupFailures: {
      notificationUnavailable: 'This browser does not provide the Notification API.',
      permissionDefault: 'Notification permission was not granted.',
      serviceWorkerUnavailable: 'The notification service worker could not be started.',
      pushUnavailable: 'This browser does not provide push notifications.',
      vapidUnavailable: 'The server is not configured with a push notification key.',
  ...
  modelProfiles: {
    ...
    presetsTab: 'Presets',
    rolesTabTitle: 'Role Bindings',
    rolesTabDescription:
      'Bind each role to a durable profile, inherit from a source role, or keep legacy compatibility.',
    profilesTabTitle: 'Profiles',
    profilesTabDescription: 'Reusable provider and model records used by role bindings.',
    credentialsTabTitle: 'API Credentials',
    credentialsTabDescription: 'Store provider secrets once and reference them from model profiles.',
    ...
    manualModelOption: 'Manual model id',
    apiKeyLabel: 'API Key',
    ...
    runtimeOverridesTitle: 'Runtime Overrides',
  ...
  agentPresets: {
    ...
    settingsDescription: 'Reusable auxiliary agent plans for chat generation.',
    ...
    stepCount: (count: number) => `${count} enabled step${count === 1 ? '' : 's'}`,
    ...
    deleteStepConfirm: (name: string) => `Delete step "${name}"?`,
