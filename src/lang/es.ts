export const languageSpanish = {
  ...
  help: {
    ...
    groupOtherBotRole:
      'Esto define un rol que se usa en el chat grupal para personajes que no son el hablante.',
    chatHTML:
  ...
  supaDesc:
    'SupaMemory es un sistema de memoria a largo plazo que utiliza datos resumidos para la IA.',
