...
| **B — Phase 5** Lorebooks stub | ✅ behind opt-in flag | `77bf6290`, `d90a2d38` | no-data-loss watcher invariant + the full globalLore stub/hydration activation, gated behind the EXPERIMENTAL `enableLorebookStubs` advanced setting (OFF by default, NOT RECOMMENDED). Data-safe (hydrate-on-open + dispatch guard). Pending: maintainer real-app validation of the full reader surface; module-lorebook stubbing deferred. |
